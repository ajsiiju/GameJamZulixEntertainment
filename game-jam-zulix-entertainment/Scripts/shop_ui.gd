...
signal on_buy_skill(skill_number)
...
func _ready() -> void:
	...
	$shop_bg/skill_offer1/buy_button1.pressed.connect(buy_skill(1))
	$shop_bg/skill_offer2/buy_button1.pressed.connect(buy_skill(2))
	$shop_bg/skill_offer3/buy_button1.pressed.connect(buy_skill(3))
	$shop_bg/skill_offer4/buy_button1.pressed.connect(buy_skill(4))
...
func buy_skill(skill_number: int):
	on_buy_skill.emit(skill_number)
